...
// BinaryCoin Testnet v0.1.4 scheduled hard fork.
inline constexpr std::uint64_t TESTNET_DIFFICULTY_FORK_HEIGHT = 30;
inline constexpr std::uint64_t TESTNET_RETARGET_INTERVAL = 20;
inline constexpr std::uint32_t TESTNET_TARGET_BLOCK_SECONDS = 60;
inline constexpr std::uint32_t TESTNET_POW_LIMIT_BITS = TESTNET_BITS;
