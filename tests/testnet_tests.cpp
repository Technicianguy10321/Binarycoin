...
int main() {
    try {
        ...
        const auto bootstrap_directory = std::filesystem::temp_directory_path() /
            "binarycoin-v013-bootstrap-test";
        ...
        std::cout << "All BinaryCoin Testnet Alpha v0.1.3 consensus, storage, HD wallet, peer, headers-first, live-relay and reorganization tests passed.\n";
        return 0;
