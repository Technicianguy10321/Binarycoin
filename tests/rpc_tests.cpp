...
int main() {
    try {
        const auto root = std::filesystem::temp_directory_path() / "binarycoin-v013-rpc-test";
        ...
        std::filesystem::remove_all(root);
        std::cout << "BinaryCoin Testnet Alpha v0.1.3 RPC and cookie-authentication tests passed.\n";
        return 0;
